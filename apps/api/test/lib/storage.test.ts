...
describe("createStorageClient", () => {
	...
	describe("getUploadUrl", () => {
		it("returns presigned upload result with url, method, fields, key, expiresAt", async () => {
		...
		it("does not include SSE field for event-image category", async () => {
			mockCreatePresignedPost.mockResolvedValueOnce({
				url: "https://presigned-post.example.com/test",
				fields: {
					key: "events/images/event-1/generated.jpg",
		...
		it("calls createPresignedPost with content-length, content-type, and SSE conditions", async () => {
