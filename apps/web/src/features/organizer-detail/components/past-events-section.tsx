...
/**
 * Past events list rendered on the public organizer profile (I-2.3.3).
 *
 ...
 *
 * The empty state mirrors the dashed-border placeholder used by the
 * upcoming-events section so empty surfaces feel consistent across the
 * profile.
 */
			...
			{events.length === 0 ? (
				<div className="rounded-xl border border-dashed border-border bg-card/50 px-6 py-10 text-center">
					<p className="text-sm text-muted-foreground">
						{organizerName} hasn't run any past events yet.
					</p>
				</div>
			) : (
