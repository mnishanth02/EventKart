...
- `SENTRY_DSN` is public-safe (ok in VITE\_\* client env)
...
| --- | ------------------------------------------ | ------------------------------------------ | ------ | ---------- | ------- | ---------------------------------------- |
| 1   | Add SENTRY\_\* env vars to config schema   | `apps/api/src/lib/config.ts`               | modify | S          | —       | ✅ 2026-07-23                            |
...
| #   | Task                                         | File                                               | Action | Complexity | Depends | Done              |
| --- | -------------------------------------------- | -------------------------------------------------- | ------ | ---------- | ------- | ----------------- |
| 10  | Add VITE*SENTRY*\* env vars to public env    | `apps/web/src/lib/env/public.ts`                   | modify | S          | —       | ✅ (pre-existing) |
| 11  | Add SENTRY\_\* server env vars               | `apps/web/src/lib/env/server.ts`                   | modify | S          | —       | ✅ (pre-existing) |
...
| File                              | Action                                                |
| --------------------------------- | ----------------------------------------------------- |
| `src/lib/config.ts`               | modify — add SENTRY\_\* env vars                      |
...
| `.env.example`                    | modify — add SENTRY\_\* vars                          |
...
| File                                      | Action                                      |
| ----------------------------------------- | ------------------------------------------- |
| `src/lib/env/public.ts`                   | modify — add VITE*SENTRY*\* vars            |
| `src/lib/env/server.ts`                   | modify — add SENTRY\_\* server vars         |
